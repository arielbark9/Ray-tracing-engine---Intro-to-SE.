...
public class RayTest {
    ...
    public void findClosestGeoPoint() {
        ...
        // TC01: a point in the middle of list is closest
        assertEquals("findClosestGeoPoint() doesn't work well!",
                new GeoPoint(null,new Point3D(2,0,0)), ray.findClosestGeoPoint(List.of(
                        new GeoPoint(null,new Point3D(4,0,0)),
                        new GeoPoint(null,new Point3D(5,0,0)),
                        new GeoPoint(null,new Point3D(2,0,0)),
                        new GeoPoint(null,new Point3D(6,0,0)))));

        // =============== Boundary Values Tests ==================

        // TC11: empty list
        assertNull("findClosestGeoPoint() doesn't work well!", ray.findClosestGeoPoint(List.of()));
