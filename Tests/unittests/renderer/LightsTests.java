...
public class LightsTests {
	...
	public void trianglesManyLights() {
		scene2.geometries.add(triangle1.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)),
				triangle2.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)));
		scene2.lights.add(new SpotLight(new Color(100000, 0, 0), new Point3D(50, -10, -130), new Vector(-2, -2, -1)) //
				.setKl(0.0001).setKq(0.000005));
		scene2.lights.add(new DirectionalLight(new Color(0,0,400),new Vector(new Point3D(0,0,-1))));
		scene2.lights.add(new PointLight(new Color(0,10000,0),new Point3D(70,20,-120)));
	...
	public void sphereManyLights() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(new Color(1000, 0, 0), new Point3D(0, -20, 50), new Vector(1, 1, -2)) //
				.setKl(0.00001).setKq(0.00000001));
		scene1.lights.add(new DirectionalLight(new Color(0, 700, 0), new Vector(0, 0, -1)));
